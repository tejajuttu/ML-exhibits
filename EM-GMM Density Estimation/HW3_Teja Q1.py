...
# plt.plot(np.mean(abs(diff)/pdf_joint), '-')
plt.hlines(np.mean(abs(diff)/pdf_joint),0,90)
plt.title("Residuals of Joint dist - product of marginal dist of amygdala and acc")
